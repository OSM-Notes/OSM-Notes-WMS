...
# Style configuration (from wms.properties.sh or defaults)
# Initialize style variables with defaults if not set
...
# install_geoserver_config() and show_configuration_summary() live in
# lib/geoserverConfig_install.sh; defining them here would shadow that module.
...
# NOTE: This function is also defined in lib/geoserverConfig_styles.sh
# The module version takes precedence, but this is kept for backward compatibility
remove_style() {
 local STYLE_NAME="${1}"
