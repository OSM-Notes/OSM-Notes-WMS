...
# Target core schema version from OSM-Notes-Ingestion (must match their base DDL
# INSERT into schema_version and docs/Schema_Versioning.md).
export SCHEMA_CONTRACT_TARGET_VERSION="${SCHEMA_CONTRACT_TARGET_VERSION:-1.1.0}"
